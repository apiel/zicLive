import { Direction, findNextSelectableItem, getSlectedItem } from './selector';
...
export function isEventUpPressed(events) {
    return events.keysDown?.includes(KEY_UP);
}
export function isEventDownPressed(events) {
    return events.keysDown?.includes(KEY_DOWN);
}
export function isEventLeftPressed(events) {
    return events.keysDown?.includes(KEY_LEFT);
}
export function isEventRightPressed(events) {
    return events.keysDown?.includes(KEY_RIGHT);
}
export function isEventMenuPressed(events) {
    return events.keysDown?.includes(KEY_MENU);
}
export function isEventEditPressed(events) {
    return events.keysDown?.includes(KEY_EDIT);
}
export function isEventEditRelease(events) {
    return events.keysUp?.includes(KEY_EDIT);
}
export function eventSelector(events, findCloseFromSameColumn = true) {
    if (events.keysDown) {
...
export function eventMenu(events) {
...
export async function eventEdit(events) {
...
export async function getEditMode(events) {

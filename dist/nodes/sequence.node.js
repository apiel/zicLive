...
function sequenceNode(id, { position, size }, { headerColor, playing, detune, next, repeat, stepCount, steps, activeStep, selected }) {
    ...
    (0, zic_node_ui_1.drawText)(`${id + 1}`.padStart(3, '0'), { x: position.x + 2, y: position.y + 1 }, { color: headerColor, size: 10, font: style_1.font.bold });
    if (next !== undefined) {
    ...
    (0, patternPreview_node_1.patternPreviewNode)(patternPosition, { w: size.w, h: size.h - (patternPosition.y - position.y) - 4 }, stepCount, steps, playing);

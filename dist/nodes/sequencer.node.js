...
export function sequencerNode(col, scrollY, onEdit, onSelected = () => { }) {
    ...
    drawText(`+`, { x: addRect.position.x + 40, y: addRect.position.y }, { color: color.info, size: 40, font: font.bold });
}

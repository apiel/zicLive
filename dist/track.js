...
exports.loadTracks = exports.getTrackStyle = exports.getTrackCount = exports.getTrack = exports.getTracks = void 0;
...
const getTrackStyle = (id) => style_1.color.tracks[id % style_1.color.tracks.length];
exports.getTrackStyle = getTrackStyle;
